...
local xmlstr = urdfreader.loadFile(etasl_application_share_dir .. "/robot_models/urdf_models/robot_setups/left_kuka_iiwa/use_case_setup_iiwa.urdf")
local robot_worldmodel = urdfreader.readUrdf(xmlstr,{})
-- robot:writeDot("kuka_iiwa_robot.dot")
local VL = {}
local frames = robot_worldmodel:getExpressions(VL,ctx,{tcp_frame = {'left_gripper','world'}, FT_sensor_frame = {'left_ft_sensor_frame', 'world'}})
