...
-- TODO: Can change this to position constraints to avoid drift
Constraint{
    context = ctx,
    name    = "follow_position_x",
...
-- TODO: Change for constant rotation and not angular velocities
Constraint{
    context = ctx,
    name    = "x_angular",
...
traveled_distance_z = Variable{
	context=ctx,
	name='traveled_distance_z',
	vartype ='feature',
	initial = 0
};
...
-- monitor_dist_z = Monitor{
-- 						context=ctx,
-- 						name='finish_after_distance',
-- 						upper = 0.025,
-- 						actionname='event',
