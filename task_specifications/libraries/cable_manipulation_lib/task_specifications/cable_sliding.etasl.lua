...
T_board_target = frame(target_position_board)

T_root_target = T_root_board * T_board_target
target_position = origin(T_root_target)
...
start_pose_diff  = inv(start_pose)*task_frame
...
target_position_t = start_position + diff*d
