...
def main(args=None):
    ...
    my_node = BeTFSMNode.get_instance("up_and_down_etasl_example")
    ...
    load_task_list("$[etasl_ros2_application_template]/coordination/fsm/betfsm/task_configuration/up_and_down_etasl_example.json",blackboard)
