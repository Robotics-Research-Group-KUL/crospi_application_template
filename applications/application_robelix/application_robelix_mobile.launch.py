...
def generate_launch_description():
    ...
    urdf_file_name = 'robot_models/urdf_models/robot_setups/robelix/use_case_setup_robelix_mobile.urdf'
    config_rviz_file = 'robot_models/urdf_models/robot_setups/robelix/rviz_config_mobile.rviz' # Replace with your RViz config file path
